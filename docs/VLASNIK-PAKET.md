...
**Stanje repoa (2026-06-04):** CI Run [#149](https://github.com/Marko200322/omni-group/actions/runs/26933987866) zelen (`0194d1f`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
