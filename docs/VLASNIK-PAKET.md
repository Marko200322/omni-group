...
**Stanje repoa (2026-06-04):** CI Run [#173](https://github.com/Marko200322/omni-group/actions/runs/26940510021) zelen (`0621a8c`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
