...
**Stanje repoa (2026-06-04):** CI Run [#171](https://github.com/Marko200322/omni-group/actions/runs/26939601776) zelen (`d5a7f09`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
