...
**Stanje repoa (2026-06-04):** CI Run [#109](https://github.com/Marko200322/omni-group/actions/runs/26922253407) zelen (`b188005`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
