...
**Stanje repoa (2026-06-04):** CI Run [#193](https://github.com/Marko200322/omni-group/actions/runs/26947924950) zelen (`14c7b5a`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
