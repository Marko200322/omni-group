...
**Stanje repoa (2026-06-04):** CI Run [#175](https://github.com/Marko200322/omni-group/actions/runs/26941808555) zelen (`0f6b26a`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
