...
**Stanje repoa (2026-06-04):** CI Run [#137](https://github.com/Marko200322/omni-group/actions/runs/26930113605) zelen (`eebfb0f`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
