...
**Stanje repoa (2026-06-03):** CI Run [#79](https://github.com/Marko200322/omni-group/actions/runs/26913676435) zelen · N2 **0.3** zatvoren · lokalni staging gate PASS · **čeka vlasnika:** Korak 1 (branch protection) + staging deploy na URL.
