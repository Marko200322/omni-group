...
**Stanje repoa (2026-06-04):** CI Run [#130](https://github.com/Marko200322/omni-group/actions/runs/26928047658) zelen (`eb23cfb`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
