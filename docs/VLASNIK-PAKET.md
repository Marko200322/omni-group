...
**Stanje repoa (2026-06-04):** CI Run [#93](https://github.com/Marko200322/omni-group/actions/runs/26918671739) zelen (`106ebec`) · deploy SHA = poslednji zelen CI · **čeka vlasnika:** branch protection + staging deploy na URL.
