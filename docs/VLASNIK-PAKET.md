...
**Stanje repoa (2026-06-04):** CI Run [#197](https://github.com/Marko200322/omni-group/actions/runs/26949010798) zelen (`df1e890`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
