...
**Stanje repoa (2026-06-04):** CI Run [#180](https://github.com/Marko200322/omni-group/actions/runs/26944537023) zelen (`70475c4`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
