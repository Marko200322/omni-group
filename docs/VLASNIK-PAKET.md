...
**Stanje repoa (2026-06-04):** CI Run [#124](https://github.com/Marko200322/omni-group/actions/runs/26925440514) zelen (`186f53b`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
