...
**Stanje repoa (2026-06-04):** CI Run [#127](https://github.com/Marko200322/omni-group/actions/runs/26926945858) zelen (`1553a0b`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
