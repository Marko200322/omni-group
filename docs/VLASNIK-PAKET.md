...
**Stanje repoa (2026-06-04):** CI Run [#167](https://github.com/Marko200322/omni-group/actions/runs/26938368617) zelen (`e7115fb`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
