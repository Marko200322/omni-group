...
**Stanje repoa (2026-06-03):** CI Run [#84](https://github.com/Marko200322/omni-group/actions/runs/26915731231) zelen (`ae4a84f`) · N2 **0.3** zatvoren · lokalni staging gate PASS · **čeka vlasnika:** Korak 1 (branch protection) + staging deploy na URL.
