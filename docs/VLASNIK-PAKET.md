...
**Stanje repoa (2026-06-04):** CI Run [#157](https://github.com/Marko200322/omni-group/actions/runs/26935823732) zelen (`c1b6701`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
