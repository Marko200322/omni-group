...
**Stanje repoa (2026-06-04):** CI Run [#163](https://github.com/Marko200322/omni-group/actions/runs/26937253166) zelen (`006c305`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
