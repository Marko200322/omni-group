...
**Stanje repoa (2026-06-04):** CI Run [#91](https://github.com/Marko200322/omni-group/actions/runs/26918066441) zelen (`0e71631`) · [`STAGING-LOCAL-PREFLIGHT-LATEST.md`](./STAGING-LOCAL-PREFLIGHT-LATEST.md) · **čeka vlasnika:** branch protection + staging deploy na URL.
