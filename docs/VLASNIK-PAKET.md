...
**Stanje repoa (2026-06-04):** CI Run [#144](https://github.com/Marko200322/omni-group/actions/runs/26933025695) zelen (`eedfed3`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
