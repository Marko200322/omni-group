...
**Stanje repoa (2026-06-04):** CI Run [#135](https://github.com/Marko200322/omni-group/actions/runs/26929353807) zelen (`8d7e44a`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
