...
**Stanje repoa (2026-06-04):** CI Run [#165](https://github.com/Marko200322/omni-group/actions/runs/26937757657) zelen (`c943eb9`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
