...
**Stanje repoa (2026-06-04):** CI Run [#178](https://github.com/Marko200322/omni-group/actions/runs/26943412974) zelen (`cbb9332`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
