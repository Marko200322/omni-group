...
**Stanje repoa (2026-06-04):** CI Run [#191](https://github.com/Marko200322/omni-group/actions/runs/26947369369) zelen (`e98f47c`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
