...
**Stanje repoa (2026-06-04):** CI Run [#203](https://github.com/Marko200322/omni-group/actions/runs/26951147409) zelen (`6dcb42c`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
