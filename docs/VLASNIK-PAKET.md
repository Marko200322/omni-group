...
**Stanje repoa (2026-06-04):** CI Run [#133](https://github.com/Marko200322/omni-group/actions/runs/26928648124) zelen (`a29e82c`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
