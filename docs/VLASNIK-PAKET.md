...
**Stanje repoa (2026-06-04):** CI Run [#105](https://github.com/Marko200322/omni-group/actions/runs/26921361550) zelen (`ece8013`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
