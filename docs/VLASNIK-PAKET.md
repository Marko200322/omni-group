...
**Stanje repoa (2026-06-04):** CI Run [#112](https://github.com/Marko200322/omni-group/actions/runs/26923159308) zelen (`391f437`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
