...
**Stanje repoa (2026-06-04):** CI Run [#201](https://github.com/Marko200322/omni-group/actions/runs/26950515160) zelen (`f592e6c`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
