...
**Stanje repoa (2026-06-04):** CI Run [#159](https://github.com/Marko200322/omni-group/actions/runs/26936294829) zelen (`0a547d1`) - handoff: [STAGING-LOCAL-PREFLIGHT-LATEST.md](./STAGING-LOCAL-PREFLIGHT-LATEST.md) - **ceka vlasnika:** branch protection + staging deploy na URL.
