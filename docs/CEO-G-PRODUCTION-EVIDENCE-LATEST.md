...
**Poslednji pregled repoa (2026-06-04):** lokalni preduslov **PASS** (`9b99d56`) — CI Run [#89](https://github.com/Marko200322/omni-group/actions/runs/26917439481). Handoff: [`STAGING-LOCAL-PREFLIGHT-LATEST.md`](./STAGING-LOCAL-PREFLIGHT-LATEST.md) (`refresh-staging-handoff.ps1`). **Staging/prod red ispod i dalje prazan** (8 stavki ceka vlasnika na URL-u).
