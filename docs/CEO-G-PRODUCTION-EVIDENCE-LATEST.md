...
**Poslednji pregled repoa (2026-06-03):** lokalni preduslov **PASS** (`464185a`) — `staging-smoke-remote`, `owner-smoke-all`, servisi `:3000`/`:3010`. CI Run [#86](https://github.com/Marko200322/omni-group/actions/runs/26916425006) zelen. Detalji: [`STAGING-LOCAL-PREFLIGHT-LATEST.md`](./STAGING-LOCAL-PREFLIGHT-LATEST.md). **Staging/prod red ispod i dalje prazan** (8 stavki ceka vlasnika na URL-u).
