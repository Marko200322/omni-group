...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#144](https://github.com/Marko200322/omni-group/actions/runs/26933025695) na `main` (`eedfed3`), **5/5** jobova PASS. Niz zelenih run-ova: #77-144.
