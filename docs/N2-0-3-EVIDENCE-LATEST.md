...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#155](https://github.com/Marko200322/omni-group/actions/runs/26935369577) na `main` (`e5aff48`), **5/5** jobova PASS. Niz zelenih run-ova: #77-155.
