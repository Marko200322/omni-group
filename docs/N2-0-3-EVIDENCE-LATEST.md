...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#141](https://github.com/Marko200322/omni-group/actions/runs/26931813183) na `main` (`d304f6d`), **5/5** jobova PASS. Niz zelenih run-ova: #77-141.
