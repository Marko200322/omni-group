...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#169](https://github.com/Marko200322/omni-group/actions/runs/26938967154) na `main` (`6867799`), **5/5** jobova PASS. Niz zelenih run-ova: #77-169.
