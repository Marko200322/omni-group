...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#195](https://github.com/Marko200322/omni-group/actions/runs/26948560946) na `main` (`3681f4d`), **5/5** jobova PASS. Niz zelenih run-ova: #77-195.
