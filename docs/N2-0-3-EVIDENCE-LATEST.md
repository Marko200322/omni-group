...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#165](https://github.com/Marko200322/omni-group/actions/runs/26937757657) na `main` (`c943eb9`), **5/5** jobova PASS. Niz zelenih run-ova: #77-165.
