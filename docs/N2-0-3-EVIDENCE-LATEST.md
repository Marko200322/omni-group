...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#212](https://github.com/Marko200322/omni-group/actions/runs/26977510523) na `main` (`3536018`), **5/5** jobova PASS. Niz zelenih run-ova: #77-212.
