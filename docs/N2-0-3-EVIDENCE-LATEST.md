...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#137](https://github.com/Marko200322/omni-group/actions/runs/26930113605) na `main` (`eebfb0f`), **5/5** jobova PASS. Niz zelenih run-ova: #77-137.
