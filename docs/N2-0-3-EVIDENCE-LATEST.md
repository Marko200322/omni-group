...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#149](https://github.com/Marko200322/omni-group/actions/runs/26933987866) na `main` (`0194d1f`), **5/5** jobova PASS. Niz zelenih run-ova: #77-149.
