...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#97](https://github.com/Marko200322/omni-group/actions/runs/26919713660) na `main` (`56813fd`), **5/5** jobova PASS. Niz zelenih run-ova: #77-97.
