...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#193](https://github.com/Marko200322/omni-group/actions/runs/26947924950) na `main` (`14c7b5a`), **5/5** jobova PASS. Niz zelenih run-ova: #77-193.
