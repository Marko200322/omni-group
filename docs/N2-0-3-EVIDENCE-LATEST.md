...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` — Run [#89](https://github.com/Marko200322/omni-group/actions/runs/26917439481) na `main` (`9b99d56`), **5/5** jobova PASS. Niz zelenih run-ova: #77–#89.
