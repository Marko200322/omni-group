...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` — Run [#92](https://github.com/Marko200322/omni-group/actions/runs/26918365736) na `main` (`86eb54f`), **5/5** jobova PASS. Niz zelenih run-ova: #77–#92.
