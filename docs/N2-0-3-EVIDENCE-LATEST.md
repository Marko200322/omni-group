...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#105](https://github.com/Marko200322/omni-group/actions/runs/26921361550) na `main` (`ece8013`), **5/5** jobova PASS. Niz zelenih run-ova: #77-105.
