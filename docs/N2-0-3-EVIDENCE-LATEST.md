...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#139](https://github.com/Marko200322/omni-group/actions/runs/26930996183) na `main` (`26008e6`), **5/5** jobova PASS. Niz zelenih run-ova: #77-139.
