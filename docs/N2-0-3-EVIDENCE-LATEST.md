...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#130](https://github.com/Marko200322/omni-group/actions/runs/26928047658) na `main` (`eb23cfb`), **5/5** jobova PASS. Niz zelenih run-ova: #77-130.
