...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#207](https://github.com/Marko200322/omni-group/actions/runs/26976468069) na `main` (`18075ed`), **5/5** jobova PASS. Niz zelenih run-ova: #77-207.
