...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#178](https://github.com/Marko200322/omni-group/actions/runs/26943412974) na `main` (`cbb9332`), **5/5** jobova PASS. Niz zelenih run-ova: #77-178.
