...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#167](https://github.com/Marko200322/omni-group/actions/runs/26938368617) na `main` (`e7115fb`), **5/5** jobova PASS. Niz zelenih run-ova: #77-167.
