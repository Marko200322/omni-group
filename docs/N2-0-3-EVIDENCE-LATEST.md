...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#151](https://github.com/Marko200322/omni-group/actions/runs/26934393505) na `main` (`c023ae9`), **5/5** jobova PASS. Niz zelenih run-ova: #77-151.
