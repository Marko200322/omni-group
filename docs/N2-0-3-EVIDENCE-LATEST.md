...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#205](https://github.com/Marko200322/omni-group/actions/runs/26961093632) na `main` (`36a6aee`), **5/5** jobova PASS. Niz zelenih run-ova: #77-205.
