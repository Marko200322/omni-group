...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#109](https://github.com/Marko200322/omni-group/actions/runs/26922253407) na `main` (`b188005`), **5/5** jobova PASS. Niz zelenih run-ova: #77-109.
