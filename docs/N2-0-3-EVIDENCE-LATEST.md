...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#98](https://github.com/Marko200322/omni-group/actions/runs/26920048026) na `main` (`02f5dfc`), **5/5** jobova PASS. Niz zelenih run-ova: #77-98.
