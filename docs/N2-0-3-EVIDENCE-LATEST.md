...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#147](https://github.com/Marko200322/omni-group/actions/runs/26933548350) na `main` (`94d6855`), **5/5** jobova PASS. Niz zelenih run-ova: #77-147.
