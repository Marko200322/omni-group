...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#214](https://github.com/Marko200322/omni-group/actions/runs/26978285738) na `main` (`46311d9`), **5/5** jobova PASS. Niz zelenih run-ova: #77-214.
