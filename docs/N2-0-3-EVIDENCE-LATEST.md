...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#163](https://github.com/Marko200322/omni-group/actions/runs/26937253166) na `main` (`006c305`), **5/5** jobova PASS. Niz zelenih run-ova: #77-163.
