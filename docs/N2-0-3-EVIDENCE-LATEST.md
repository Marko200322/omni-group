...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#191](https://github.com/Marko200322/omni-group/actions/runs/26947369369) na `main` (`e98f47c`), **5/5** jobova PASS. Niz zelenih run-ova: #77-191.
