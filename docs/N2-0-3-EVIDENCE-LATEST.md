...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#135](https://github.com/Marko200322/omni-group/actions/runs/26929353807) na `main` (`8d7e44a`), **5/5** jobova PASS. Niz zelenih run-ova: #77-135.
