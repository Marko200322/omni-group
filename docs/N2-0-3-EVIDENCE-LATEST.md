...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#201](https://github.com/Marko200322/omni-group/actions/runs/26950515160) na `main` (`f592e6c`), **5/5** jobova PASS. Niz zelenih run-ova: #77-201.
