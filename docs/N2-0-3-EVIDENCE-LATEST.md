...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#118](https://github.com/Marko200322/omni-group/actions/runs/26924166672) na `main` (`0c57e61`), **5/5** jobova PASS. Niz zelenih run-ova: #77-118.
