...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#95](https://github.com/Marko200322/omni-group/actions/runs/26919262267) na `main` (`7a8d9f5`), **5/5** jobova PASS. Niz zelenih run-ova: #77-95.
