...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#96](https://github.com/Marko200322/omni-group/actions/runs/26919533469) na `main` (`80040d5`), **5/5** jobova PASS. Niz zelenih run-ova: #77-96.
