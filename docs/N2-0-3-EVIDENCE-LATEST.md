...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#188](https://github.com/Marko200322/omni-group/actions/runs/26946275285) na `main` (`7509b0d`), **5/5** jobova PASS. Niz zelenih run-ova: #77-188.
