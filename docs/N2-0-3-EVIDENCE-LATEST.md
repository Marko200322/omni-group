...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#94](https://github.com/Marko200322/omni-group/actions/runs/26918947287) na `main` (`7484594`), **5/5** jobova PASS. Niz zelenih run-ova: #77-94.
