...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#153](https://github.com/Marko200322/omni-group/actions/runs/26934940518) na `main` (`10cef4b`), **5/5** jobova PASS. Niz zelenih run-ova: #77-153.
