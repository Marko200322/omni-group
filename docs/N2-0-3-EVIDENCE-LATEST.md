...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#120](https://github.com/Marko200322/omni-group/actions/runs/26924602250) na `main` (`dfa56ba`), **5/5** jobova PASS. Niz zelenih run-ova: #77-120.
