...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#210](https://github.com/Marko200322/omni-group/actions/runs/26977019841) na `main` (`5459929`), **5/5** jobova PASS. Niz zelenih run-ova: #77-210.
