...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#171](https://github.com/Marko200322/omni-group/actions/runs/26939601776) na `main` (`d5a7f09`), **5/5** jobova PASS. Niz zelenih run-ova: #77-171.
