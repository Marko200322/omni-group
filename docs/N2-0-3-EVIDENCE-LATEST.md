...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#107](https://github.com/Marko200322/omni-group/actions/runs/26921682004) na `main` (`ca49750`), **5/5** jobova PASS. Niz zelenih run-ova: #77-107.
