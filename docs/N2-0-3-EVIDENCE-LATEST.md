...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` — Run [#91](https://github.com/Marko200322/omni-group/actions/runs/26918066441) na `main` (`0e71631`), **5/5** jobova PASS. Niz zelenih run-ova: #77–#91.
