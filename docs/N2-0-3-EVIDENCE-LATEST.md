...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#103](https://github.com/Marko200322/omni-group/actions/runs/26921051881) na `main` (`8cb4552`), **5/5** jobova PASS. Niz zelenih run-ova: #77-103.
