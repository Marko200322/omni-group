...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#203](https://github.com/Marko200322/omni-group/actions/runs/26951147409) na `main` (`6dcb42c`), **5/5** jobova PASS. Niz zelenih run-ova: #77-203.
