...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#185](https://github.com/Marko200322/omni-group/actions/runs/26945684927) na `main` (`3d89f03`), **5/5** jobova PASS. Niz zelenih run-ova: #77-185.
