...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#101](https://github.com/Marko200322/omni-group/actions/runs/26920636042) na `main` (`90b4c2b`), **5/5** jobova PASS. Niz zelenih run-ova: #77-101.
