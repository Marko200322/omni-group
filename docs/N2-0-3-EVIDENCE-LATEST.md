...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#180](https://github.com/Marko200322/omni-group/actions/runs/26944537023) na `main` (`70475c4`), **5/5** jobova PASS. Niz zelenih run-ova: #77-180.
