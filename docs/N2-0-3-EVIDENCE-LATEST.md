...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#122](https://github.com/Marko200322/omni-group/actions/runs/26925046014) na `main` (`2d00e26`), **5/5** jobova PASS. Niz zelenih run-ova: #77-122.
