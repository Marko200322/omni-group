...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#197](https://github.com/Marko200322/omni-group/actions/runs/26949010798) na `main` (`df1e890`), **5/5** jobova PASS. Niz zelenih run-ova: #77-197.
