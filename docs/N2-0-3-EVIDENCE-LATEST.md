...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#110](https://github.com/Marko200322/omni-group/actions/runs/26922560840) na `main` (`92a47d9`), **5/5** jobova PASS. Niz zelenih run-ova: #77-110.
