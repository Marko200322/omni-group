...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#133](https://github.com/Marko200322/omni-group/actions/runs/26928648124) na `main` (`a29e82c`), **5/5** jobova PASS. Niz zelenih run-ova: #77-133.
