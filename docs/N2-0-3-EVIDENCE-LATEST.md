...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#124](https://github.com/Marko200322/omni-group/actions/runs/26925440514) na `main` (`186f53b`), **5/5** jobova PASS. Niz zelenih run-ova: #77-124.
