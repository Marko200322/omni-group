...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#199](https://github.com/Marko200322/omni-group/actions/runs/26949466895) na `main` (`18315e5`), **5/5** jobova PASS. Niz zelenih run-ova: #77-199.
