...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#161](https://github.com/Marko200322/omni-group/actions/runs/26936812128) na `main` (`7f13650`), **5/5** jobova PASS. Niz zelenih run-ova: #77-161.
