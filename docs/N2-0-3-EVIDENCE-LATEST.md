...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#175](https://github.com/Marko200322/omni-group/actions/runs/26941808555) na `main` (`0f6b26a`), **5/5** jobova PASS. Niz zelenih run-ova: #77-175.
