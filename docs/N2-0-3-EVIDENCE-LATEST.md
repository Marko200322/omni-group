...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#127](https://github.com/Marko200322/omni-group/actions/runs/26926945858) na `main` (`1553a0b`), **5/5** jobova PASS. Niz zelenih run-ova: #77-127.
