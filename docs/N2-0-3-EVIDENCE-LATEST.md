...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#173](https://github.com/Marko200322/omni-group/actions/runs/26940510021) na `main` (`0621a8c`), **5/5** jobova PASS. Niz zelenih run-ova: #77-173.
