...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` - Run [#99](https://github.com/Marko200322/omni-group/actions/runs/26920257413) na `main` (`b36c405`), **5/5** jobova PASS. Niz zelenih run-ova: #77-99.
