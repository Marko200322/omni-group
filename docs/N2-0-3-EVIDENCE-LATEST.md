...
**Poslednji pregled repoa (2026-06-04):** **zelen** `CI (monorepo)` — Run [#90](https://github.com/Marko200322/omni-group/actions/runs/26917757755) na `main` (`c919d79`), **5/5** jobova PASS. Niz zelenih run-ova: #77–#90.
