...
**Datum:** 2026-06-04  
**Commit za deploy:** [8cb4552](https://github.com/Marko200322/omni-group/commit/8cb4552ad6c358fb3a47504591e685272bc96d39) (CI run 6e663f8 docs-only; deploy app kod 8cb4552)  
**CI:** Run [#104](https://github.com/Marko200322/omni-group/actions/runs/26921200279) - **5/5 PASS**
...
|------|----------|----------|
| GitHub CI (monorepo) | **PASS** | poslednji run #104 |
...
**Disk C:** ~0.29 GB - ispod 1 GB; staging-preflight koristi `-MinDiskGb 1`

---

## Vlasnik - posle deploya na staging URL

1. Deploy **8cb4552** (Atina + web + Nest po [STAGING-RELEASE-CHECKLIST.md](./STAGING-RELEASE-CHECKLIST.md))
