...
**Poslednji pregled repoa (2026-06-03):** CI na `main` **zelen** (Run [#82](https://github.com/Marko200322/omni-group/actions/runs/26914914873), `923b5ca`) — spremno za Korak 3 (required checks). Branch protection **još nije** podešen.
