...
**Poslednji pregled repoa (2026-06-03):** CI na `main` **zelen** (Run [#86](https://github.com/Marko200322/omni-group/actions/runs/26916425006), `464185a`) — spremno za Korak 3 (required checks). Branch protection **još nije** podešen.
