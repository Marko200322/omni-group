...
**Poslednji pregled repoa (2026-06-03):** CI na `main` **zelen** (Run [#88](https://github.com/Marko200322/omni-group/actions/runs/26917024714), `9db6234`) — spremno za Korak 3 (required checks). Branch protection **još nije** podešen.
