...
**Poslednji pregled repoa (2026-06-04):** CI na `main` **zelen** (Run [#147](https://github.com/Marko200322/omni-group/actions/runs/26933548350), `94d6855`) - spremno za Korak 3 (required checks). Branch protection **jos nije** podeÅ¡en.
