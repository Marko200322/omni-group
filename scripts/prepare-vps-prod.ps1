...
$copyKeys = @(
  ...
  'MANUAL_PAYMENT_CURRENCY', 'MANUAL_PAYMENT_NOTE', 'COMPANY_LEGAL_NAME', 'COMPANY_TAX_ID', 'COMPANY_ADDRESS',
  'TELEGRAM_BOT_TOKEN', 'TELEGRAM_CHAT_ID',
  'ELEVENLABS_API_KEY', 'HEYGEN_API_KEY', 'DID_API_KEY', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET',
  'STRIPE_PUBLISHABLE_KEY', 'SLACK_WEBHOOK_URL', 'CONTACT_SLACK_WEBHOOK_URL', 'HUNTER_API_KEY', 'NEVERBOUNCE_API_KEY', 'ZEROBOUNCE_API_KEY',
