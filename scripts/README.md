...
**GitHub CI bez `gh auth`:** [`github-ci-status.ps1`](./github-ci-status.ps1) — poslednji Actions run + job rezime. **Branch protection spremnost:** [`branch-protection-ready.ps1`](./branch-protection-ready.ps1). **Vlasnik sledeci koraci (deploy):** [`staging-owner-next.ps1`](./staging-owner-next.ps1). **Disk / cleanup:** [`disk-report.ps1`](./disk-report.ps1) · [`free-disk-space.ps1`](./free-disk-space.ps1).
