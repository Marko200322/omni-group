...
export const KANON_SECTIONS: KanonSection[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'P0-01', title: 'DMARC TXT u Spaceship', status: 'DONE', owner: 'Agent', note: 'TXT verified 2026-09-20' },
      { id: 'P0-02', title: 'Resend Domains → Verify (send-only)', status: 'DONE', owner: 'Agent', note: 'receiving disabled; DNS OK' },
      { id: 'P0-03', title: 'Instantly warmup + env flag', status: 'DONE', owner: 'Agent', note: 'warmupComplete=true prod' },
      { id: 'P0-04', title: 'Slack webhook — kontakt form', status: 'DONE', owner: 'Agent', note: 'deploy 2026-09-20' },
      { id: 'P0-05', title: 'Slack webhook — ops', status: 'DONE', owner: 'Agent', note: 'deploy 2026-09-20' },
      { id: 'P0-06', title: 'Mystery shopper + Confirm → PDF u inboxu', status: 'DONE', owner: 'Agent', note: 'INV-202609-0879.pdf u Gmail' },
