...
export const DELIVERABLE_CATALOG: DeliverableDefinition[] = [
  ...
  { id: 'vertical-package', name: 'Vertical solution', nameSr: 'Vertikalni paket rešenja', description: 'CRM + automatizacije + AI podrška po industriji.', billing: 'monthly', category: 'vertical', anchorEur: 179, resources: { aiTokensK: 80, scraperRuns: 8, infraHours: 4, supportHours: 2, storageGbMonth: 3, deployComplexity: 3 }, modules: ['crm', 'automation', 'support-avatar', 'billing'] },
  ...
  { id: 'ai-support-retainer', name: 'AI support retainer', nameSr: 'AI podrška retainer', description: 'AI avatar + video sastanci za vaše klijente.', billing: 'monthly', category: 'vertical', anchorEur: 249, resources: { aiTokensK: 120, scraperRuns: 0, infraHours: 2, supportHours: 2, storageGbMonth: 2, deployComplexity: 2 }, modules: ['support-avatar', 'video-meetings'] },
...
export const DELIVERABLE_CATEGORY_LABELS: Record<DeliverableDefinition['category'], string> = {
  ...
  retainer: 'Mesečni retainer',
  growth: 'Rast i marketing',
  vertical: 'Vertikalna rešenja',
};
