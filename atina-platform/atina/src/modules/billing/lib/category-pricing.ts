...
> = {
  budget: {
    ...
    labelSr: 'Mali biznis',
    multiplier: 0.86,
    description: 'Salons, hospitality, retail — competitive entry vs EU agencies, same deliverables.',
  },
  standard: {
    label: 'Standard',
    labelSr: 'Standard',
    multiplier: 0.96,
    description: 'Typical SMB — aligned with productized EU agency mid-market.',
  },
  premium: {
    label: 'Premium',
    labelSr: 'Premium',
    multiplier: 1.04,
    description: 'Finance, legal, tech — compliance-heavy scope.',
  },
  regulated: {
    label: 'Regulated',
