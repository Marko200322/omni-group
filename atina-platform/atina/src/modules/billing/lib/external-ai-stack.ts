...
export const EXTERNAL_AI_STACK: ExternalAiVendorDef[] = [
  ...
  },
  {
    ...
    sector: 'sales_lead_gen',
    sectorLabel: 'Prodaja & Lead Gen',
    purpose: 'Cold email sequences from warmed inboxes (outbound queue → campaign)',
    purposeSr: 'Cold email sekvence sa warmed inboxova (outbound → kampanja)',
    envKeys: ['INSTANTLY_API_KEY', 'INSTANTLY_CAMPAIGN_ID'],
    monthlyCostEur: { min: 97, max: 358 },
    fromPhase: 'M4',
