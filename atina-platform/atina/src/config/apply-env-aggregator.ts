...
export type EnvAggregatorSection = 'atina' | 'nest' | 'omnigroupWeb' | 'youtubePipeline';
...
/** Apply monorepo defaults from config/env-aggregator.json (does not override existing process.env). */
export function applyEnvAggregator(section: EnvAggregatorSection): void {
