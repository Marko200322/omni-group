...
- [x] Git repozitorijum: koren = `omni group`, `main` zaštićen, PR obavezni pre merge-a — **DONE 2026-08-05** · [`docs/GIT-A-EVIDENCE-LATEST.md`](./docs/GIT-A-EVIDENCE-LATEST.md) · uputstvo: [`docs/GIT-BRANCH-PROTECTION.md`](./docs/GIT-BRANCH-PROTECTION.md) · (opciono kasnije: required CI status checks)
...
- [x] Vlasnik rollback-a i uslovi za rollback definisani — [`docs/ROLLBACK-OWNER.md`](./docs/ROLLBACK-OWNER.md) · STATUS-KANON LIVE-09
